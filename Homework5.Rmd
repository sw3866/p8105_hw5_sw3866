...
The sample average of $\mu$ across tests for which the null is rejected is **not** approximately equal to the true value of $\mu$ due to the inherent randomness and variability present in sampling and statistical inference.
